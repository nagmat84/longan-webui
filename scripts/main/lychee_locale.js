...
lychee.locale = {
	...
	ALBUM_SHR_NO: "No",
	ALBUM_PUBLIC: "Public",
	ALBUM_PUBLIC_EXPL: "These options only apply, if the album is shared with anonymous users.",
	ALBUM_FULL: "Full size (v4 only)",
	ALBUM_FULL_EXPL: "Full-resolution pictures are available",
	ALBUM_HIDDEN: "Hidden",
	ALBUM_HIDDEN_EXPL: "Anonymous users need the direct link to access this album.",
	...
	ALBUM_DOWNLOADABLE_EXPL: "The user can download this album.",
